...
##3 way
Gen_val_interaction1_3 <- lm(value~consistency*valence*membership,data=my_data_gender_T)
summary(Gen_val_interaction1_3)
#visualize
...
##3 way
Gen_val_interaction1_4 <- lm(value~consistency*valence*membership,data=my_data_gender_A)
summary(Gen_val_interaction1_4)
#visualize
...
my_data_extracted_A_T <- subset(my_data_original, select = c("ID", "agegroup_subj", "Consistency","Format",
...
##3 way
Gen_val_interaction1_3 <- lm(value~consistency*valence*membership,data=my_data_age_T)
summary(Gen_val_interaction1_3)
#visualize
ggplot(data = my_data_gender_T, mapping = aes(x = valence, y = value, 
                                              color = membership)) + 
...
##3 way
Gen_val_interaction1_3 <- lm(value~consistency*valence*membership,data=my_data_age_A)
summary(Gen_val_interaction1_3)
#visualize
ggplot(data = my_data_gender_T, mapping = aes(x = valence, y = value, 
                                              color = membership)) + 
...
##3 way
Gen_val_interaction1_3 <- lm(value~consistency*valence*membership,data=my_data_gender_A)
summary(Gen_val_interaction1_3)
#visualize
ggplot(data = my_data_gender_T, mapping = aes(x = valence, y = value, 
                                              color = membership)) + 
